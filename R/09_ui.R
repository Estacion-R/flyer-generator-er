...
# Link "volver a Inicio" que se repite arriba del todo en cada generador --
# la landing es la única entrada de navegación visible (el resto de las tabs
# se esconde de la barra con CSS, ver .navbar-nav en css_app), así que cada
# página necesita una salida explícita de vuelta. `suffix` evita IDs de
# input duplicados entre tabs (Shiny los pisa si se repiten) -- cada tab
# tiene su propio observeEvent en app.R.
back_to_home <- function(suffix) {
...
build_ui <- function() {
  ...
  # ---- Tabs Instagram: una por tipo de carrusel, sin selector interno ----
  # Hasta acá esto era UN solo nav_panel con un selectInput "Tipo de
  # carrusel" que mostraba/ocultaba 4 conditionalPanel -- exactamente el
  # "menú desplegable" que la landing (arriba) debía reemplazar, solo que un
  # nivel más adentro. Se separó en 4 tabs dedicadas (2026-09-17), cada una
  # con su propio sidebar y su propio preview, sin selector de tipo. El
  # server sigue usando `ig_tipo()` para las 4 ramas de lógica compartida
  ...
  nav_panel(
    ...
    layout_sidebar(
      sidebar = sidebar(
        ...
        downloadButton("descargar_zip_paquete",
          "⬇ Descargar ZIP", class = "btn-zip", style = "margin-top: 1rem;")
      ),
  ...
  nav_panel(
    "🎓 Carrusel de curso", value = "ig_curso",
    layout_sidebar(
      sidebar = sidebar(
        width = 340,
        class = "panel-form",
        ...
        downloadButton("descargar_zip_curso",
          "⬇ Descargar ZIP", class = "btn-zip", style = "margin-top: 1rem;")
      ),
  ...
  nav_panel(
    "🎴 Tarjeta de curso", value = "ig_tarjeta",
    layout_sidebar(
      sidebar = sidebar(
        width = 340,
        class = "panel-form",
        back_to_home("tarjeta"),
        ...
        downloadButton("descargar_zip_tarjeta",
          "⬇ Descargar ZIP", class = "btn-zip", style = "margin-top: 1rem;")
      ),
  ...
  nav_panel(
    "🏷️ Tarjeta de descuento", value = "ig_descuento",
    layout_sidebar(
      sidebar = sidebar(
        width = 340,
        class = "panel-form",
        back_to_home("descuento"),
        ...
        downloadButton("descargar_zip_descuento",
          "⬇ Descargar ZIP", class = "btn-zip", style = "margin-top: 1rem;")
      ),
